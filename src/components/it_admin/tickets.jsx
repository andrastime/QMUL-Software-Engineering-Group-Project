        ...
        {currentData.map((ticket, index) => (
          ...
          >
            <h2
              ...
              style={{ width: "20%", "text-overflow": "ellipses" }}
            >
              {ticket.title}
            </h2>
            <p style={{ width: "35%", "text-overflow": "ellipses" }}>
              {ticket.description}
            </p>
            ...
            >
              <div className="started-by">
                ...
                <div style={{ display: "flex", "flex-direction": "column" }}>
                  ...
                  <p>
                    {new Date(ticket.date_posted).toLocaleDateString("en-US", {
                      day: "2-digit",
                      month: "long",
                    })}
                  </p>
